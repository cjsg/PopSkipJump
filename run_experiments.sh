...
for beta in $betas; do
  for attack in $attacks; do
    echo "========================================"
    exp_name="$dataset""_$attack""_r_$repeat""_dm_$dm""_b_$beta""_$noise""_fp_$flip""_ns_$num_samples"
    export CUDA_VISIBLE_DEVICES=$device
    echo "Device: $device"
    fixed_params="-d $dataset -pf 0.1 -q 5 -ns $num_samples -r $repeat -fp $flip -dm $dm"
